...
- the merging, indexing, and verification logic
- the version lineage and provenance documentation
- the `instructions_for_llm` block

It does **not** and **cannot** cover the embedded Längle source quotations. Those short verbatim excerpts from:
...
- Längle, A. (2011b). The Existential Fundamental Motivations Structuring the Motivational Process. In D. Leontiev (Ed.), *Motivation, Consciousness and Self-Regulation* (pp. 27–42). Nova Science Publishers.
...
LLM-derived text in this codebook (e.g., the `instructions_for_llm` block, scoring rubrics, sub-theme labels) is treated as the author's contribution — produced through the multi-LLM methodology described in `docs/lineage.md` — and is covered by the CC BY 4.0 license.
...
Questions about source-quotation usage or licensing edge cases:
Graham Nelson-Zutter · graham@aestra.ca
